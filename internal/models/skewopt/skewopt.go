...
// SkewOpt implements the Skew-Opt (Skewness Ranking Optimization) algorithm for network embedding
...
// New creates a new Skew-Opt model
func New() *SkewOpt {
	return &SkewOpt{
...
// Train trains the Skew-Opt model
// Parameters:
...
// SaveWeights saves the Skew-Opt learned embeddings to a file
