...
.PHONY: all clean deepwalk node2vec fastrp transe rotate sne metapath2vec han ctdne line bpr hpe test

all: deepwalk node2vec fastrp transe rotate sne metapath2vec han ctdne line bpr hpe
