...
#### Node2Vec
- **Paper**: [node2vec: Scalable Feature Learning for Networks](https://dl.acm.org/citation.cfm?id=3098036) (KDD 2016)
...
#### gSASRec
- **Paper**: [gSASRec: Graph-based Self-Attentive Sequential Recommendation](https://arxiv.org/abs/2108.06479) (RecSys 2023 Best Paper)
- **Command**: `./bin/gsasrec`
- **Description**: Extends SASRec with graph-based item representations

#### Rec-Denoiser
- **Paper**: [Rec-Denoiser: A Denoising Model for Recommendation](https://dl.acm.org/doi/10.1145/3523227.3546771) (RecSys 2022 Best Paper)
- **Command**: `./bin/recdenoiser`
- **Description**: Denoising approach for robust recommendations

#### SkewOpt
- **Paper**: [Unbiased Learning for the Causal Effect of Recommendation](https://arxiv.org/abs/2008.09945) (RecSys 2020)
- **Command**: `./bin/skewopt`
- **Description**: Addresses selection bias in recommendation

### Signed Network Models

#### SNE (Signed Network Embedding)
- **Paper**: [Deep Signed Network Embedding](https://dl.acm.org/citation.cfm?id=3098086) (CIKM 2017)
- **Command**: `./bin/sne`
